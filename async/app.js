...
const stages=[{title:'ללמוד בזמן ובמקום שמתאימים לכם',label:'זמן ומקום',text:'פתחו את יחידות הלמידה העצמית בזמן ובמקום שמתאימים לכם והתקדמו בקצב שנוח לכם.',icon:'book',shot:'חומרי הלמידה העצמית בקורס',image:'https://tanyat-cmd.github.io/elevationhub/async/zman.jpg'},{title:'לעצור, לחזור ולהתקדם בקצב שלכם',label:'עוצרים וחוזרים',text:'עצרו כשצריך, חזרו על הסברים שלא היו ברורים והמשיכו רק כשאתם מרגישים מוכנים.',icon:'book',shot:'חזרה על הסברים בחומרי הקורס',image:'https://tanyat-cmd.github.io/elevationhub/async/stop.jpg'},{title:'לבדוק את ההבנה',label:'בדיקת הבנה',text:'ענו על שאלות ובצעו תרגולים ובדיקות הבנה כדי לוודא שהידע ברור ומוכן ליישום.',icon:'play',shot:'שאלות ותרגולים לבדיקת ההבנה',image:'https://tanyat-cmd.github.io/elevationhub/async/check.jpg'},{title:'להגיע מוכנים למפגשים החיים',label:'מפגש חי',text:'השלימו את היחידות והתרגולים מראש, והגיעו למפגש החי מוכנים לשאול, לתרגל ולקבל משוב.',icon:'calendar',shot:'הצטרפות למפגש החי',image:'https://tanyat-cmd.github.io/elevationhub/async/zoom.jpg'}];
...
balanceStyle.href = 'balance.css?v=38';
